            ...
            <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
                <textarea
                    className="min-w-[304px] w-full min-h-[112px] text-sm 
                        ...
                        rounded-md focus:border-brand-500 focus:ring-brand-500 focus-ring-1
                        resize-none focus:outline-none scrollbar scrollbar-thumb-zinc-700
                        scrollbar-track-transparent scrollbar-thin"
                    placeholder="Descreva com detalhes o problema que está a acontecer:"
